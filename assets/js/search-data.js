    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-started-the-100-day-cuda-programming-challenge-following-along-with-programming-massively-parallel-processors-pmpp-documenting-my-progress-daily-as-i-dive-deep-into-gpu-computing-and-parallel-programming-follow-my-journey-on-github",
          title: '🚀 Started the 100-day CUDA programming challenge! Following along with Programming Massively Parallel...',
          description: "",
          section: "News",},{id: "projects-selective-kv-quantization",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-rich-teacher-features-for-efficient-single-image-haze-removal",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-semi-supervised-reinforcement-learning-for-autonomous-agents",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-super-resolution-enhanced-face-recognition",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%61%73%75%72%65%73%31%33@%6A%68.%65%64%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/anushrisuresh", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/anushrisuresh", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=hQNaX7oAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
